            ...
            <div class="container">
                <div class="list">
                    <div class="left">
                        ...
                        <ul>
                            <li class="leftOn" onclick="location.href='teacher-tutor.jsp'">讲师</li>
                            <li onclick="location.href='teacher-subpro.jsp'">副教授</li>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="teacher-left">
                                                <img src="../resources/images/teacher_BO.jpg" alt="" class="teacher-img">
                                                <p class="teacher-name">王波</p>
                                            </div>
                                            <div class="teacher-box">
                                                ...
                                                <a href="teacherinfo.jsp" class="teacher-link">查看简历</a>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="teacher-left">
                                                <img src="../resources/images/bianjilong.jpg" alt="" class="teacher-img">
                                                <p class="teacher-name">边继龙</p>
                                            </div>
                                            <div class="teacher-box">
                                                <dl>
                                                    <dt>电话:</dt>
                                                ...
                                                <dl><dt>研究方向:</dt><dd>网络信息处理、人工智能、自然语言处理、生物信息学、声图文智能计算、商业智能等</dd></dl>
                                                <dl><dt>教学课目:</dt><dd>Web程序设计、系统程序设计、Java。</dd></dl>
                                                <a href="teacherinfo-bianjilong.jsp" class="teacher-link">查看简历</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
