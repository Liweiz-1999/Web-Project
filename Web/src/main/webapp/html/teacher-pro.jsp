                ...
                <div class="list">
                    <div class="left">
                        ...
                        <ul>
                            ...
                            <li class="leftOn" onclick="location.href='teacher-pro.jsp'">教授</li>
                        </ul>
                    </div>
                    <div class="right">
                        <div class="right-box">
                            ...
                            <div class="list-box">
                                <div class="teacher-content">
                                    <ul>
                                        ...
                                        <li>
                                            <div class="teacher-left">
                                                <img src="../resources/images/sm-su.jpg" alt="" class="teacher-img">
                                                <p class="teacher-name">苏建民</p>
                                            </div>
                                            <div class="teacher-box">
                                                <dl>
                                                    <dt>电话:</dt>
                                                ...
                                                <dl><dt>研究方向:</dt><dd>网络信息处理、人工智能、自然语言处理、生物信息学、声图文智能计算、商业智能等</dd></dl>
                                                <dl><dt>教学课目:</dt><dd>Web程序设计、系统程序设计、Java。</dd></dl>
                                                <a href="teacherinfo-sujianmin.jsp" class="teacher-link">查看简历</a>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
